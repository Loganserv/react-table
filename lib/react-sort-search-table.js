...
var SortableTblTd = function SortableTblTd(props) {
	...
	var oddClassName = props.index % 2 ? "jsonOdd" : "jsonEven";

	return _react2.default.createElement(
		"tr",
		{ className: "jsonRow jsonRow_" + props.index + " " + oddClassName },
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				this.props.search && _react2.default.createElement(
					...
					'Busca: ',
					_react2.default.createElement('input', { className: 'search', type: 'text', name: '', value: this.state.filter, onChange: this.filter })
				),
				_react2.default.createElement(
					'div',
					{ className: "module filtered changelist" },
					_react2.default.createElement(
						'table',
						{ className: 'jsonTable' },
						_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							pageData.map(function (item, id) {
								return _react2.default.createElement(_SortableTblTd.SortableTblTd, _extends({ key: id, index: id, tdData: item }, _this2.props, { dKey: _this2.props.dKey, customTd: _this2.props.customTd }));
							})
						)
					)
				),
